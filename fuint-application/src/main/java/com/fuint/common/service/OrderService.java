...
public interface OrderService extends IService<MtOrder> {
     ...
     * 计算购物车
     * */
    Map<String, Object> calculateCartGoods(Integer userId, List<MtCart> cartList, Integer couponId, boolean isUsePoint, String platform) throws BusinessCheckException;
