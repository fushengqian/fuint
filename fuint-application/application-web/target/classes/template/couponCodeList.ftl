...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
  <Created>2016-11-28T13:53:36Z</Created>
  <LastSaved>2016-11-28T13:53:36Z</LastSaved>
 ...
 <Styles>
  ...
  <Style ss:ID="s72">
   ...
   <Borders/>
   <Font ss:FontName="宋体" x:CharSet="134" ss:Size="12" ss:Color="#0066CC"
    ss:Bold="1"/>
  </Style>
  <Style ss:ID="s74">
 ...
 <Worksheet ss:Name="卡券码信息">
  <Table ss:ExpandedColumnCount="13"  x:FullColumns="1"
   ...
   <Row>
    ...
    <Cell ss:StyleID="s59"><Data ss:Type="String">获取来源</Data></Cell>
    <Cell ss:StyleID="s59"><Data ss:Type="String">用户ID</Data></Cell>
   </Row>
 
   <#if resultList?exists>
   <#list resultList as ls>
   <Row ss:AutoFitHeight="0">
    <Cell ss:StyleID="s70"><Data ss:Type="String">${ls.activityCode?default("")}</Data></Cell>
    <Cell ss:StyleID="s70"><Data ss:Type="String">${ls.activityName?default("")}</Data></Cell>
    <Cell ss:StyleID="s70"><Data ss:Type="String">${ls.couponCode?default("")}</Data></Cell>
    <Cell ss:StyleID="s70"><Data ss:Type="String">${ls.exchangeCode?default("")}</Data></Cell>
    <Cell ss:StyleID="s70"><Data ss:Type="String">${ls.status?default("")}</Data></Cell>
    <Cell ss:StyleID="s70"><Data ss:Type="String">${ls.receiveType?default("")}</Data></Cell>
    <Cell ss:StyleID="s70"><Data ss:Type="String">${ls.userId?default("")}</Data></Cell>
   </Row>
   </#list> 
   </#if>
