...
public class SourceController {
    ...
    public String addSource(HttpServletRequest request, HttpServletResponse response, Model model) {
        List<TreeNode> sources = sSourceService.getSourceTree();
        List<TreeNode> treeNodes = new ArrayList<TreeNode>();
        TreeUtil.convert(TreeUtil.sourceTreeNodes(sources), treeNodes);
        model.addAttribute("sourceTree", treeNodes);
    ...
    public String addSourceHandler(HttpServletRequest request, HttpServletResponse response, Model model) throws BusinessCheckException {
    ...
    public String editSource(HttpServletRequest request, HttpServletResponse response, Model model, @PathVariable("sourceid") Long sourceid) {
    ...
    public String editSourceHandler(HttpServletRequest request, HttpServletResponse response, Model model, @PathVariable("sourceid") Long sourceid) throws BusinessCheckException {
        TSource editSource = (TSource) RequestHandler.createBean(request, new TSource());
    ...
    public String deleteAccount(HttpServletRequest request, HttpServletResponse response, Model model, @PathVariable("sourceid") Long sourceid) throws BusinessCheckException {
        try {
